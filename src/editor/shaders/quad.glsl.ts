/**
 * Shared vertex shader. Crop, straighten, 90° rotation and flips are folded
 * into `uUvTransform` so geometry costs nothing beyond the UV it already
 * samples (spec §6, "Crop/transform … handled as vertex-level transform").
 */
